...
#define FO_PROTOCOL_VERSION                   ( 0xFA11 ) // FOnline Protocol Version
...
#define NETMSG_ADD_ITEM_SIZE            \
    ( sizeof( uint ) + sizeof( uint ) + \
      sizeof( ushort ) + sizeof( uchar ) + ITEM_DATA_SIZE )
// ////////////////////////////////////////////////////////////////////////
//
// Params:
// uint id
...
#define NETMSG_ADD_ITEM_ON_MAP_SIZE     \
    ( sizeof( uint ) + sizeof( uint ) + \
      sizeof( ushort ) * 3 + sizeof( uchar ) + ITEM_DATA_SIZE )
// ////////////////////////////////////////////////////////////////////////
//
// Params:
// uint item_id
...
#define NETMSG_CHANGE_ITEM_ON_MAP_SIZE        ( sizeof( uint ) + sizeof( uint ) + ITEM_DATA_SIZE )
// ////////////////////////////////////////////////////////////////////////
//
// Params:
// uint item_id
...
#define NETMSG_PLAYERS_BARTER_SET_HIDE_SIZE \
    ( sizeof( uint ) + sizeof( uint ) +     \
      sizeof( ushort ) + sizeof( uint ) + ITEM_DATA_SIZE )
// ////////////////////////////////////////////////////////////////////////
//
// uint id
// ushort pid
...
#define NETMSG_SEND_FILE_IN_COLLECTION                  MAKE_NETMSG_HEADER( 171 )
// ////////////////////////////////////////////////////////////////////////
...
#define NETMSG_SEND_LOOK_DATA_SIZE                  ( sizeof( uint ) + 29*2 ) // 29 - OFFSETOF(LookData, dir)
// ////////////////////////////////////////////////////////////////////////
// Send LookData
// LookData critter
// LookData map
...
#define NETMSG_PREPARE_SEND_FILE_TO_SERVER                        MAKE_NETMSG_HEADER( 174 )
// ////////////////////////////////////////////////////////////////////////
